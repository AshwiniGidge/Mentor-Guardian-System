    ...
    <font size="6" color="#FFFF00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Mentoring System</font>
        ...
        <div id="menu">
                <ul class="navigation">
                    ...
                    <li><a href="mentor.jsp" class="selected">Mentor</a></li>
        ...
        <br><Br><br>  
        <center>  <form name="myform" action="mentoract.jsp" method="post">
        <table  style="border:0px solid;width: 50%">
         <font color="white" size="5">Mentor Login</font></h2> 
         <br><br>
         <tr><td><font color="white">User Name :</td><td><input type="text" name="fname" required="" /></td></tr>
         <tr><td><br><font color="white">Password  :</td><td><br><input type="password" name="password" required="" /></td></tr>
         <tr><td><font color="white">Year :</td><td><input type="text" name="yr" required="" /></td></tr>
         <tr><td><br><font color="white">Semester  :</td><td><br><input type="text" name="sem" required="" /></td></tr>
        ...
        <h2>Sidebar Menu</h2>
        <li><a href="admin.jsp"  style="text-decoration:none;color:black;"><font size="3">Admin</a></li>
