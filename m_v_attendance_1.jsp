...
<center>
    <center>
                          <form action="m_v_attendance.jsp">
                              <table  style="border:0px solid;width:400px">
                                  <tr>
                                      <td>
                                          <label style="font-size: 20px">Select Student:</label>
                                      </td>&nbsp;&nbsp;&nbsp;&nbsp;
        <td>
            <select name="sname" style="width: 80px" required="">
   ...
   <%
        ...
        PreparedStatement pst=con.prepareStatement("select * from student where mentor='"+mentor+"'");    
	...
	ResultSet rs=pst.executeQuery();
        ...
        while(rs.next()){
            ...
            <option value="<%=rs.getString("sname")%>"><%=rs.getString("sname")%></option>
