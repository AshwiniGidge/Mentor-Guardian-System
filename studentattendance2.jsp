...
<body>
    ...
    <font size="6" color="#FFFF00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Mentoring System</font>
     ...
     <br>
     <center> 
      <form action="studentattendance1.jsp" metohd="post">
       <font color="white" size="5">Attendance Details</font> 
       <br><br>
	<tr><td><font color="white">Start Date :</td><td><input type="text" name="date" placeholder="DD/MM/YYYY" style="width:165px;" required="" /></td></tr>
        <br><br> 
        <tr><td><font color="white">End Date :</td><td><input type="text" name="to" placeholder="DD/MM/YYYY" style="width:165px;" required="" /></td></tr>   
        <br>     
