...
%>
        ...
        <h2>Mentor Menu</h2>
             <li><a href="adminhome.jsp"  style="text-decoration:none;color:black;"><font size="3">Home</a></li>
              ...
              <li><a href="addsubjects.jsp"style="text-decoration:none;color:black;">Add Subjects</a></li>
              <li><a href="aavg.jsp"style="text-decoration:none;color:black;">Average</a></li>
