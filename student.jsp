...
<body>
        ...
        <script>alert('Invalid Email Id or Password!!');</script>
        <%}%> 
    <style>
        .li {
    ...
    <font size="6" color="#FFFF00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Mentoring System</font>
        ...
        <br><Br><br>  
        <center>  <form name="myform" action="studentact.jsp" method="post">
                <table style="border:0px solid; width: 50%">
         <font color="white" size="5">Student Login</font></h2> 
         <br><br>
                 <tr><td><font color="white">Email Id :</td><td><input type="email" name="email" required="" /></td></tr>
        ...
        <ul>
              ...
              <li><a href="contact.jsp"style="text-decoration:none;color:black;">Contact</a></li>
        </ul>
         </div>
         </div> 
         </div>
