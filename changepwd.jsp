...
<body>
    ...
    <font size="6" color="#FFFF00">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Mentoring System</font>
        ...
        <br><Br><br>  
                    <center>  <form action="changepwdact.jsp" method="post">
                <table style="border:0px solid; width: 50%">
         <font color="white" size="5">Reset Password</font></h2> 
         <br><br><br>
                 <tr><td><font color="white">Old Password</td><td><input type="text" name="op" required="" /></td></tr>
         <tr><td><br><font color="white">Enter a New Password</td><td><br><input type="password" name="np" required="" /></td></tr>

         <tr align="center"><td colspan="2" style="text-align:center"><br><input type="submit" name="submit" value="    Reset    " /></td></tr>
         <tr></tr>      
         </table>
         </form>
         </center>	
